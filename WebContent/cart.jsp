...
 				$('.form-control.quantity-input').change(function() { 
	       alert(111+"dsada"+this.id);             
	var id=this.id;
	 				...
	 				<div class="row">
					 						...
					 						<div class="info">
						 						<div class="row">
							 						...
							 						<div class="col-md-3 quantity">
							 							...
							 							<input id="quantity_<%=p.getProduct_id()%>_" type="number" value ="<%= p.getQty() %>" class="form-control quantity-input">
							 						</div>
							 						<div class="col-md-3 price">
							 							<span>$<%= String.format("%.2f", price) %></span>
							 						</div>
							 						<div class="col-md-2 ">
							 							<div class="remove" id="remove_<%=p.getProduct_id()%>_">
							 								<button>X</button>
							 							</div>
							 						</div>
							 					</div>
			 			...
			 			<div class="col-md-12 col-lg-4">
			 				<div class="summary">
			 					...
			 					<button type="button" id="placeorder" class="btn btn-primary btn-lg btn-block">Place Order</button>
