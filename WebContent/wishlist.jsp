...
<head>
  ...
  <link href="css/shop-wishlistpage.css" rel="stylesheet">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <%ApiClass ac = new ApiClass();
		  	...
		  	ArrayList<ProductsController> products = ac.getList((Integer)request.getSession().getAttribute("userid"), "W");
          ...
          <div class="col-lg-4 col-md-6 mb-4 h-25">
            <div class="card">
              <div  class="productTag"><img class="card-img-top" src="resources/image/<%=p.getProduct_name()%>.jpg" alt="">
              <div class="card-body">
                <h4 class="card-title">
                  <%= p.getProduct_name()%>
                </h4>
              ...
              <div class="card-footer">
              	<div class="desc">
                <button class="cart" id="<%= p.getProduct_id()%>">Add to Cart</button>
               	</div>
              </div>
              </div>
            </div>
